...
const stats = [
  { label: 'Matches Played', value: 120, suffix: '' },
  { label: 'Wins', value: 78, suffix: '' },
  { label: 'Championships', value: 3, suffix: '' },
  { label: 'Fans', value: 500, suffix: 'K+' },
];
    ...
    <section className="section-padding relative overflow-hidden bg-white/[0.018]">
      <div className="container-page relative">
        <SectionHeader
          ...
          description="Performance, support, and ambition — the Falcons measure progress with standards that keep rising."
        />
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, index) => (
            <motion.div
              ...
              whileHover={{ y: -7 }}
            >
              <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-falcon-blue to-transparent" />
