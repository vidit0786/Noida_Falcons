  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href="#matches"
          className="premium-button hidden border border-falcon-blue/60 bg-falcon-blue/90 text-white shadow-glow hover:border-white/30 hover:bg-falcon-blue lg:inline-flex"
        >
          Match Center
        </a>
