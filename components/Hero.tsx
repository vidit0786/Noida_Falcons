...
function StadiumBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_18%,rgba(10,77,155,.36),transparent_34%),linear-gradient(180deg,rgba(0,0,0,.2)_0%,#050505_92%)]" />
      <div className="absolute inset-x-[-10%] bottom-[10%] h-[42%] rounded-[100%_100%_0_0] border-t border-white/10 bg-[radial-gradient(ellipse_at_center,rgba(192,192,192,.22),rgba(10,77,155,.1)_38%,transparent_70%)] opacity-80" />
      ...
      <div className="absolute left-[8%] top-[9%] h-[56%] w-1 origin-bottom rotate-[18deg] bg-gradient-to-b from-white/45 via-falcon-blue/20 to-transparent blur-[1px]" />
      <div className="absolute left-[4%] top-[7%] h-16 w-40 rotate-[18deg] rounded-full bg-white/45 blur-3xl" />
      <div className="absolute right-[8%] top-[9%] h-[56%] w-1 origin-bottom -rotate-[18deg] bg-gradient-to-b from-white/45 via-falcon-blue/20 to-transparent blur-[1px]" />
      <div className="absolute right-[4%] top-[7%] h-16 w-40 -rotate-[18deg] rounded-full bg-white/45 blur-3xl" />
      <div className="absolute left-[22%] top-[14%] h-36 w-36 rounded-full bg-falcon-blue/25 blur-3xl" />
      <div className="absolute right-[22%] top-[14%] h-36 w-36 rounded-full bg-falcon-blue/25 blur-3xl" />
    ...
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden pt-28">
      ...
      <div className="container-page relative z-10 grid items-center gap-12 pb-16 lg:grid-cols-[1.05fr_.95fr] lg:pb-0">
        <motion.div variants={textContainer} initial="hidden" animate="show" className="max-w-4xl">
          ...
          >
            Noida <span className="block bg-gradient-to-r from-white via-falcon-silver to-falcon-blue bg-clip-text text-transparent">Falcons</span>
          </motion.h1>
          ...
          >
            The Official Home of Noida&apos;s Premier Cricket Franchise. Built on fearless pace, sharp strategy, and the roar of a city ready to fly.
          </motion.p>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              href="#squad"
              className="premium-button border border-falcon-blue bg-falcon-blue text-white shadow-glow"
            >
              Explore Squad
            </motion.a>
            <motion.a
        ...
        <motion.div
          ...
          aria-hidden="true"
        >
          <div className="absolute inset-0 rounded-full bg-radial-blue blur-2xl" />
          <motion.div
            className="absolute inset-[9%] rounded-full border border-white/10 bg-white/[0.045] shadow-glass backdrop-blur-xl"
            animate={{ y: [0, -12, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
          >
            <div className="absolute inset-8 rounded-full border border-falcon-blue/50" />
            <div className="absolute inset-16 rounded-full border border-white/10" />
            <div className="absolute left-1/2 top-1/2 h-[74%] w-[74%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-white/10 via-falcon-blue/15 to-black/70" />
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <TeamLogo showText={false} size="lg" />
            </div>
            <span className="absolute left-8 top-20 rounded-full border border-white/10 bg-black/55 px-4 py-2 text-xs font-black uppercase tracking-[0.28em] text-falcon-silver">Elite T20</span>
            <span className="absolute bottom-20 right-8 rounded-full border border-falcon-blue/50 bg-falcon-blue/25 px-4 py-2 text-xs font-black uppercase tracking-[0.28em] text-white">Noida</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
