...
function SponsorLogo({ name }: { name: string }) {
  return (
    <div className="mx-3 flex h-24 min-w-56 items-center justify-center rounded-[1.7rem] border border-white/10 bg-white/[0.055] px-8 shadow-glass backdrop-blur-xl grayscale transition duration-300 hover:-translate-y-1 hover:border-falcon-blue/45 hover:bg-white/[0.09] hover:grayscale-0">
      <div className="text-center">
        <p className="bg-gradient-to-r from-white via-falcon-silver to-falcon-blue bg-clip-text text-2xl font-black uppercase tracking-tight text-transparent">
          {name}
        </p>
